...
module.exports = tseslint.config(
   ...
   * --------------------------------------- */
  {
    ...
    rules: {
      ...
      '@angular-eslint/template/click-events-have-key-events': 'off', // ✅ PrimeNG handles accessibility
      '@angular-eslint/template/prefer-control-flow': ['warn', { allowNullOrUndefined: true }],
    },
  },
);
